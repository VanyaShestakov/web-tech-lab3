package com.ivanshestakov.lab.server.repository.impl;
...
public class StudentServerRepositoryImpl implements StudentServerRepository {
    ...
    public List<Student> getAll() {
        ...
        try (XMLDecoder decoder = new XMLDecoder(
                new BufferedInputStream(
                        new FileInputStream(StudentServerRepositoryImpl.STUDENTS_XML)))) {
            do {
    ...
    public void rewriteStudents(List<Student> students) throws FileNotFoundException {
        try (XMLEncoder encoder = new XMLEncoder(
                new BufferedOutputStream(
                        new FileOutputStream(StudentServerRepositoryImpl.STUDENTS_XML)))) {
    ...
    public User userExists(User user) {
        ...
        try (XMLDecoder decoder = new XMLDecoder(
                new BufferedInputStream(
                        new FileInputStream(StudentServerRepositoryImpl.USERS_XML)))) {
    ...
    public void rewriteUsers(List<User> users) throws FileNotFoundException {
        try (XMLEncoder encoder = new XMLEncoder(
                new BufferedOutputStream(
                        new FileOutputStream(StudentServerRepositoryImpl.USERS_XML)))) {
