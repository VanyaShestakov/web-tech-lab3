package com.ivanshestakov.lab.server.service.impl;
...
public class StudentServerServiceImpl implements StudentServerService {
    private final StudentServerRepository studentDAO;

    public StudentServerServiceImpl(StudentServerRepository studentDAO) {
